...
public static class A21RaidProtocolSelfTest
{
	...
	private sealed class RaidJoinFixture : IDisposable
	{
		...
		public RaidJoinFixture()
		{
			...
			Peers = new PartyHandler(new PartyManager(), Characters, Sessions, null, null, null, null, GameDatabase.AttachInitialized("Data Source=:memory:"));
	...
	private static void CheckLiveRaidInviteMode(ref int failures)
	{
		...
		foreach (int existing in new[] { 0, 1, 2 })
		{
			...
			using var peers = new PartyHandler(parties, characters, sessions, null, null, null, null, GameDatabase.AttachInitialized("Data Source=:memory:"));
			peers.AttachRaidHandler(handler);
		...
		foreach (int num in array)
		{
			...
			foreach (bool flag in array2)
			{
				...
				try
				{
					...
					using PartyHandler partyHandler = new PartyHandler(partyManager, characterRepository, sessionDirectory, null, null, null, null, GameDatabase.AttachInitialized("Data Source=:memory:"));
